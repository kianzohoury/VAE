...
model this process with a neural network? Yes. In fact, generative models of the 
form p_{θ}(x) are designed exactly for the purpose of generating new data points given
