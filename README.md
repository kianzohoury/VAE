...
of that, we cannot know exactly which $z$ will cleanly produce a digit. Figure 4
visualizes the exact latent space generated by the vanilla autoencoder for MNIST
test data:
...
<p align="center">
    <i> Figure 4. Generated digits from a grid in the 2D latent space.. </i>
</p>
